...
app.post("/handleforgetpassword", async (req, res) => {
  ...
  let info = await transporter.sendMail({
    ...
    html: `
      ...
      <br>
      <br>Your Email is:</br> <span>${email}</span>
      <br>
      <a href="https://notesbynodejs.herokuapp.com/resetpassword/${token}">Click to reset your password</a>
      `,
  });
...
app.post(
  ...
  async (req, res) => {
    ...
    let url = req.rawHeaders
      .filter((str) => str.match("/resetpassword/"))
      .toString();
